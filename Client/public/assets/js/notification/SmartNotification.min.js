...
$.SmartMessageBox = function(a, b) {
    ...
    if (1, 0 == isIE8orlower() && $.sound_on) {
        ...
        e.setAttribute("src", $.sound_path + "messagebox.mp3"), e.addEventListener("load", function() {
            e.play()
        }, !0), e.pause(), e.play()
    }
    ...
    var f = "",
        g = 0;
    if (void 0 != a.input) switch (g = 1, a.input = a.input.toLowerCase(), a.input) {
        case "text":
            a.inputValue = "string" === $.type(a.inputValue) ? a.inputValue.replace(/'/g, "&#x27;") : a.inputValue, f = "<input class='form-control' type='" + a.input + "' id='txt" + SmartMSGboxCount + "' placeholder='" + a.placeholder + "' value='" + a.inputValue + "'/><br/><br/>";
            break;
        case "password":
            f = "<input class='form-control' type='" + a.input + "' id='txt" + SmartMSGboxCount + "' placeholder='" + a.placeholder + "'/><br/><br/>";
            break;
        case "select":
            if (void 0 == a.options) alert("For this type of input, the options parameter is required.");
            else {
                f = "<select class='form-control' id='txt" + SmartMSGboxCount + "'>";
                for (var h = 0; h <= a.options.length - 1; h++) "[" == a.options[h] ? i = "" : "]" == a.options[h] ? (j += 1, i = "<option>" + i + "</option>", f += i) : i += a.options[h];
                f += "</select>"
            }
            break;
        default:
    ...
    d = "<div class='MessageBoxContainer animated fadeIn fast' id='Msg" + SmartMSGboxCount + "'>", d += "<div class='MessageBoxMiddle'>", d += "<span class='MsgTitle'>" + a.title + "</span class='MsgTitle'>", d += "<p class='pText'>" + a.content + "</p>", d += f, d += "<div class='MessageBoxButtonSection'>", void 0 == a.buttons && (a.buttons = "[Accept]"), a.buttons = $.trim(a.buttons), a.buttons = a.buttons.split("");
    var i = "",
        j = 0;
    void 0 == a.NormalButton && (a.NormalButton = "#232323"), void 0 == a.ActiveButton && (a.ActiveButton = "#ed145b");
    for (var h = 0; h <= a.buttons.length - 1; h++) "[" == a.buttons[h] ? i = "" : "]" == a.buttons[h] ? (j += 1, i = "<button id='bot" + j + "-Msg" + SmartMSGboxCount + "' class='btn btn-default btn-sm botTempo'> " + i + "</button>", d += i) : i += a.buttons[h];
    d += "</div>", d += "</div>", d += "</div>", SmartMSGboxCount > 1 && ($(".MessageBoxContainer").hide(), $(".MessageBoxContainer").css("z-index", 99999)), $(".divMessageBox").append(d), 1 == g && $("#txt" + SmartMSGboxCount).focus(), $(".botTempo").hover(function() {
        $(this).attr("id")
    }, function() {
        $(this).attr("id")
        ...
        $("#" + c).addClass("animated fadeOut fast"), 0 == (SmartMSGboxCount -= 1) && $("#MsgBoxBack").removeClass("fadeIn").addClass("fadeOut").delay(300).queue(function() {
...
$.smallBox = function(a, b) {
    ...
    if (e = void 0 == a.iconSmall ? "<div class='miniIcono'></div>" : "<div class='miniIcono'><i class='miniPic " + a.iconSmall + "'></i></div>", c = void 0 == a.icon ? "<div id='smallbox" + SmallBoxes + "' class='SmallBox animated fadeInRight fast'><div class='textoFull'><span>" + a.title + "</span><p>" + a.content + "</p></div>" + e + "</div>" : "<div id='smallbox" + SmallBoxes + "' class='SmallBox animated fadeInRight fast'><div class='foto'><i class='" + a.icon + "'></i></div><div class='textoFoto'><span>" + a.title + "</span><p>" + a.content + "</p></div>" + e + "</div>", 1 == SmallBoxes) $("#divSmallBoxes").append(c), SmallBoxesAnchos = $("#smallbox" + SmallBoxes).height() + 40;
        ...
        0 == $(".SmallBox").length ? ($("#divSmallBoxes").append(c), SmallBoxesAnchos = $("#smallbox" + SmallBoxes).height() + 40) : ($("#divSmallBoxes").append(c), $("#smallbox" + SmallBoxes).css("top", SmallBoxesAnchos), SmallBoxesAnchos = SmallBoxesAnchos + $("#smallbox" + SmallBoxes).height() + 20, $(".SmallBox").each(function(a) {
    ...
    void 0 == a.color ? g.css("background-color", "#004d60") : g.css("background-color", a.color);
    var h;
    void 0 != a.colors && a.colors.length > 0 && (g.attr("colorcount", "0"), h = setInterval(function() {
        var b = g.attr("colorcount");
        g.animate({
            "backgroundColor": a.colors[b].color
        }), b < a.colors.length - 1 ? g.attr("colorcount", 1 * b + 1) : g.attr("colorcount", 0)
        ...
        }) : (clearInterval(h), SmallBoxesAnchos -= a, "function" == typeof b && b && b(), $("#" + f).removeClass().addClass("SmallBox").animate({
            "opacity": 0
        }, 300, function() {
            $(this).remove();
            var a = 0;
        ...
        clearInterval(h), "function" == typeof b && b && b();
        var a = $(this).height() + 20;
