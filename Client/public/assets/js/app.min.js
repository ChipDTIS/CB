function SmartMessageBox(contains, callback) {
    $.SmartMessageBox({
...
function SmartBigMessageBoxSuccess(contains) {
    $.bigBox({
        title: contains.title,
        content: contains.content,
        color: "#739E73",
...
function SmartBigMessageBoxWarning(contains) {
    $.bigBox({
        title: contains.title,
        content: contains.content,
        color: "#C46A69",
...
function SmartBigMessageBoxInformation(contains) {
    $.bigBox({
        title: contains.title,
        content: contains.content,
        color: "#3276B1",
...
//Top-righ message
function SmartSmallMessageBoxSuccess(contains) {
    $.smallBox({
        title: contains.title,
        content: contains.content,
        color: "#739E73",
...
function SmartSmallMessageBoxWarning(contains) {
    $.smallBox({
        title: contains.title,
        content: contains.content,
        color: "#C46A69",
...
function SmartSmallMessageBoxInformation(contains) {
    $.smallBox({
        title: contains.title,
        content: contains.content,
        color: "#3276B1",
...
initApp.addDeviceType(), initApp.menuPos(), jQuery(document).ready(function () {
    initApp.SmartActions(), initApp.domReadyMisc()
}),
    function (e, t, a) {
        function o() {
            n = t[l](function () {
